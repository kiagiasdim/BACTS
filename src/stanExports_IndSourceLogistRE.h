...
namespace model_IndSourceLogistRE_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_IndSourceLogistRE");
    reader.add_event(50, 48, "end", "model_IndSourceLogistRE");
    return reader;
}
#include <stan_meta_header.hpp>
class model_IndSourceLogistRE
  : public stan::model::model_base_crtp<model_IndSourceLogistRE> {
private:
        int m;
        int p;
        std::vector<int> y;
        ...
        matrix_d I;
        int npatID;
        std::vector<int> patID;
        double a_omega_u;
        double b_omega_u;
public:
    model_IndSourceLogistRE(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_IndSourceLogistRE_namespace::model_IndSourceLogistRE";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "npatID", "int", context__.to_vec());
            npatID = int(0);
            vals_i__ = context__.vals_i("npatID");
            pos__ = 0;
            npatID = vals_i__[pos__++];
            check_greater_or_equal(function__, "npatID", npatID, 0);
            current_statement_begin__ = 13;
            validate_non_negative_index("patID", "m", m);
            context__.validate_dims("data initialization", "patID", "int", context__.to_vec(m));
            patID = std::vector<int>(m, int(0));
            vals_i__ = context__.vals_i("patID");
            pos__ = 0;
            size_t patID_k_0_max__ = m;
            for (size_t k_0__ = 0; k_0__ < patID_k_0_max__; ++k_0__) {
                patID[k_0__] = vals_i__[pos__++];
            }
            size_t patID_i_0_max__ = m;
            for (size_t i_0__ = 0; i_0__ < patID_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "patID[i_0__]", patID[i_0__], 1);
                check_less_or_equal(function__, "patID[i_0__]", patID[i_0__], npatID);
            }
            current_statement_begin__ = 15;
            context__.validate_dims("data initialization", "a_omega_u", "double", context__.to_vec());
            a_omega_u = double(0);
            vals_r__ = context__.vals_r("a_omega_u");
            pos__ = 0;
            a_omega_u = vals_r__[pos__++];
            check_greater_or_equal(function__, "a_omega_u", a_omega_u, 0);
            current_statement_begin__ = 16;
            context__.validate_dims("data initialization", "b_omega_u", "double", context__.to_vec());
            b_omega_u = double(0);
            vals_r__ = context__.vals_r("b_omega_u");
            pos__ = 0;
            b_omega_u = vals_r__[pos__++];
            check_greater_or_equal(function__, "b_omega_u", b_omega_u, 0);
            ...
            validate_non_negative_index("u", "npatID", npatID);
            num_params_r__ += npatID;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 23;
        if (!(context__.contains_r("omega_u")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable omega_u missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("omega_u");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "omega_u", "double", context__.to_vec());
        double omega_u(0);
        omega_u = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, omega_u);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable omega_u: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 24;
        ...
        pos__ = 0U;
        validate_non_negative_index("u", "npatID", npatID);
        context__.validate_dims("parameter initialization", "u", "vector_d", context__.to_vec(npatID));
        Eigen::Matrix<double, Eigen::Dynamic, 1> u(npatID);
        size_t u_j_1_max__ = npatID;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 23;
            local_scalar_t__ omega_u;
            (void) omega_u;  // dummy to suppress unused var warning
            if (jacobian__)
                omega_u = in__.scalar_lb_constrain(0, lp__);
            else
                omega_u = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 24;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> u;
            (void) u;  // dummy to suppress unused var warning
            if (jacobian__)
                u = in__.vector_constrain(npatID, lp__);
            else
                u = in__.vector_constrain(npatID);
            ...
            lp_accum__.add(normal_log<propto__>(u, 0, (1 / stan::math::sqrt(omega_u))));
            current_statement_begin__ = 38;
            lp_accum__.add(gamma_log<propto__>(omega_u, a_omega_u, b_omega_u));
            ...
            for (int pat = 1; pat <= m; ++pat) {
                current_statement_begin__ = 46;
                lp_accum__.add(bernoulli_logit_log<propto__>(get_base1(y, pat, "y", 1), (get_base1(linpred, pat, "linpred", 1) + get_base1(u, get_base1(patID, pat, "patID", 1), "u", 1))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_IndSourceLogistRE_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double omega_u = in__.scalar_lb_constrain(0);
        vars__.push_back(omega_u);
        Eigen::Matrix<double, Eigen::Dynamic, 1> u = in__.vector_constrain(npatID);
        size_t u_j_1_max__ = npatID;
        for (size_t j_1__ = 0; j_1__ < u_j_1_max__; ++j_1__) {
    ...
    std::string model_name() const {
        return "model_IndSourceLogistRE";
    }
...
typedef model_IndSourceLogistRE_namespace::model_IndSourceLogistRE stan_model;
#ifndef USING_R
